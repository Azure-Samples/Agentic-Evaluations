...
======================================================
Pipeline module that enriches multi-agent orchestrator responses with
...
def load_agent_responses_jsonl(input_path: str) -> List[Dict[str, Any]]:
    """
    Load records from agent_responses.jsonl (output from multi_agent_orchestrator).

    Returns:
        List of records with id, query, response, trace_id, expected_agents, category
    """
    records = []
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        for record in local_records:
            ...
            merged = {
                ...
                "expected_agents": record.get("expected_agents", []),
