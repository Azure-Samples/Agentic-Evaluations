...
class TestAiJudgeEvaluationFactory:
    def test_get_custom_coherence(self):
        from src.evaluations.offline.ai_judge_evaluation_custom.eval_factory import EvaluatorFactory
...
class TestPipelineExperimentFactory:
    def test_get_relevance(self):
        from src.evaluations.offline.pipeline_experiment_evaluation.eval_factory import EvaluatorFactory
...
class TestPipelineMultiAgentFactory:
    def test_get_relevance(self):
        from src.evaluations.offline.pipeline_multi_agent_evaluation.eval_factory import EvaluatorFactory
...
class TestPipelineMultiToolFactory:
    def test_get_relevance(self):
        from src.evaluations.offline.pipeline_multi_tool_agent_evaluation.eval_factory import EvaluatorFactory
...
class TestRagEvaluationFoundryFactory:
    def test_get_relevance(self):
        from src.evaluations.offline.rag_evaluation_foundry.eval_factory import EvaluatorFactory
